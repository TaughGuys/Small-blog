import pymongo
import blogPostDataAcessObject
import sessionDataAccessObject
import userDataAccessObject
import bottle
import html
import cgi
import re
...
posts = blogPostDataAcessObject.BlogPostDataAccessObject(database)
users = userDataAccessObject.UserDataAccessObject(database)
sessions = sessionDataAccessObject.SessionDataAccessObject(database)
